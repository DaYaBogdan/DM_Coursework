...
INSERT INTO ACCOUNT (LOGIN, PASSWORD, FIO, EMAIL, PHONE, MONEY, ROLE) VALUES
('user1', 'pass123', 'Иванов Иван Иванович', 'ivanov@mail.ru', '+79161234567', 15000.50, 'Пользователь'),
('user2', 'pass456', 'Петров Петр Петрович', 'petrov@mail.ru', '+79162345678', 8500.00, 'Пользователь'),
('user3', 'pass789', 'Сидорова Анна Сергеевна', 'sidorova@mail.ru', '+79163456789', 12000.00, 'Пользователь'),
('user4', 'pass101', 'Кузнецов Алексей Дмитриевич', 'kuznetsov@mail.ru', '+79164567890', 5000.00, 'Пользователь'),
('user5', 'pass112', 'Смирнова Елена Владимировна', 'smirnova@mail.ru', '+79165678901', 30000.00, 'Пользователь'),
('master1', 'mast123', 'Волков Денис Игоревич', 'volkov@mail.ru', '+79166789012', 25000.00, 'Мастер'),
('master2', 'mast456', 'Козлова Мария Петровна', 'kozlova@mail.ru', '+79167890123', 18000.00, 'Мастер'),
('master3', 'mast789', 'Лебедев Сергей Александрович', 'lebedev@mail.ru', '+79168901234', 22000.00, 'Мастер'),
('master4', 'mast101', 'Новикова Ольга Викторовна', 'novikova@mail.ru', '+79169012345', 19000.00, 'Мастер'),
('master5', 'mast112', 'Морозов Игорь Николаевич', 'morozov@mail.ru', '+79160123456', 21000.00, 'Мастер'),
('admin1', 'admin123', 'Федоров Андрей Борисович', 'fedorov@mail.ru', '+79161234560', 40000.00, 'Администратор'),
('user6', 'pass131', 'Григорьева Татьяна Олеговна', 'grigoreva@mail.ru', '+79162345671', 7500.00, 'Пользователь'),
('user7', 'pass141', 'Белов Артем Константинович', 'belov@mail.ru', '+79163456782', 9200.00, 'Пользователь'),
('user8', 'pass151', 'Краснова Ирина Васильевна', 'krasnova@mail.ru', '+79164567893', 11000.00, 'Пользователь'),
('user9', 'pass161', 'Павлов Николай Львович', 'pavlov@mail.ru', '+79165678904', 16000.00, 'Пользователь');
